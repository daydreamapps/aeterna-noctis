# Aeterna Noctis - Sector Resources

## The Malakor Sector Map
    ...
    +-------------+       +------------------+       +-------------+
           \                      |                       /
            \                     |                      /
             \                    |                     /
    +-----------+          +-----------+          +-----------+
    | Veridian  |          | Sanctum   |          | Aethelgard|
    | Reach     |          | Malakor   |          | (Knight   |
    | (Agri)    |          | (Cardinal)|          |  World)   |
    +-----------+          +-----------+          +-----------+
                                 |
                                 |
...
| Status | Boon | Penalty (if Disabled) |
|--------|------|----------------------|
| Active | One free "Fresh Recruits" requisition per phase | Cannot reinforce destroyed units |
...
## The Aeterna Noctis (Space Hulk)

### Strategic Sites

Control of the Hulk is divided into four key locations:

| Site | Function | Current Controller |
|------|----------|-------------------|
| **The Bridge** | Command and navigation systems | Unclaimed |
| **The Spires** | Sensor arrays and communications | Unclaimed |
| **The Relay** | Warp engine stabilizers | Unclaimed |
| **The Hangar** | Launch bays and docking access | Unclaimed |
...
### The Guardians
*Those who seek to save the sector—or claim its protection for themselves.*

Factions aligned: TBD

### The Despoilers
*Those who would see the sector burn, if only to warm themselves by the flames.*

Factions aligned: TBD

### The Marauders
*Those who care nothing for worlds or hulks—only plunder.*

Factions aligned: TBD

---

## Environmental Hazards (by Phase)

As the worlds drift closer to the sun, conditions worsen:

| Phase | Hazard | Effect |
|-------|--------|--------|
| 1 | None | Standard conditions |
| 2 | Solar Flares | Random Mortal Wounds at battle start (D3 per unit, 5+) |
| 3 | Warp Instability | Psychic tests suffer -1; Perils on any double |
| 4 | Gravitational Stress | No Fall Back moves; units must hold position or advance |
| 5 | The Dying Light | All battles use Night Fighting rules; visibility 18" |
